...
app.listen(PORT,'0.0.0.0',()=>{console.log(`MaritimeScope Hybrid AIS bridge v10.2 listening on ${PORT}`);console.log(`Open Waters: ${!!OPENWATERS_API_KEY?'token':'anonymous'} | AISStream: ${!!AISSTREAM_API_KEY?'configured':'NOT configured'}`);console.log(`Boxes: ${JSON.stringify(BOXES)}`);setTimeout(()=>{connectOpenWaters();},2000); setTimeout(()=>{connectAISStream();},60000);});
